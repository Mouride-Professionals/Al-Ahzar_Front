      ...
      school: {
        creation: {
          ...
          isAlAzharLand: {
            ...
            select: true,
            options: [
              { name: 'forms.inputs.school.creation.isAlAzharLand.options[0].name', value: true },
              { name: 'forms.inputs.school.creation.isAlAzharLand.options[1].name', value: false },
            ],
          },
          phoneFix: {
      ...
      teacher: {
        recruitment: {
          ...
          maritalStatus: {
            ...
            uid: 'maritalStatus',
            select: true,
            options: mapOptions(teacherRecruitmentSchema.fields.maritalStatus._whitelist),
          },
          academicDegree: {
          ...
          level: {
            ...
            uid: 'level',
            select: true,
            options: mapOptions(teacherRecruitmentSchema.fields.level._whitelist),
          },
          salary: {
