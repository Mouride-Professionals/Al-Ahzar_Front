    ...
    useEffect(() => {
        const verifyEmail = async () => {
            ...
            try {
                ...
                if (response.error) {
                    throw new Error(response.error.message || t('form.verification.error_description'));
                }
                ...
                const errorMessage = error.message || t('form.verification.error_description');
                ...
                {isLoading ? (
                    ...
                    <VStack spacing={4}>
                        ...
                        >
                            ...
                            <Text as="span" color={colors.primary.regular} fontWeight="medium">
