...
import { FaDragDrop, FaFileCsv, FaFileExcel } from 'react-icons/fa';
import * as XLSX from 'xlsx';

export default function FileUploadStep({ onFileUpload, onBack, uploadedFile, status }) {
        ...
        <VStack spacing={6} align="stretch">
                ...
                <Card>
                    <CardBody p={8}>
                        ...
                        >
                            ...
                            <VStack spacing={4}>
                                <Icon
                                    as={isDragActive ? FaDragDrop : UploadIcon}
                                    boxSize={12}
                    ...
                    <Card>
                        <CardBody>
                            <VStack align="start" spacing={4}>
                                <Heading size="md">Aperçu des données (5 premières lignes)</Heading>
            ...
            <Alert status="info" borderRadius="md">
                ...
                <Box>
                    ...
                    <AlertDescription>
                        Excel (.xlsx), CSV (.csv). Assurez-vous que votre fichier utilise le modèle téléchargé.
                    </AlertDescription>
                </Box>
            </Alert>
