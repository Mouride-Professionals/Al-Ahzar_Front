            ...
            <VStack align="start" spacing={2}>
              ...
              >
                <Text color="green.600">
                  ✓ Ligne {processedCount}: Étudiant importé avec succès
                </Text>
                {errorCount > 0 && (
                  <Text color="red.600">
                    ✗ Ligne {processedCount - 1}: Erreur lors de
                    l&apos;importation
                  </Text>
                )}
      ...
      {status === 'completed' && (
        <Alert status="success" borderRadius="md">
          ...
          <Box>
            ...
            <AlertDescription>
              {successCount} étudiants ont été importés.{' '}
              {errorCount > 0 && `${errorCount} erreurs détectées.`}
            </AlertDescription>
          </Box>
        </Alert>
      )}
      ...
      {status === 'error' && (
        <Alert status="error" borderRadius="md">
          ...
          <Box>
            ...
            <AlertDescription>
              L&apos;importation a été interrompue. Veuillez réessayer ou
